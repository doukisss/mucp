...
$gszId='MUCP_VTCCI	PAGEMOD_PRINCIPALE	20230517030052';
//-----------------------------------------------------------------------
...
?>
<!DOCTYPE html>
<!-- PAGEMOD_principale 17/05/2023 03:00 WEBDEV 24 24.0.206.1 --><html lang="fr" class="htmlstd html5">
...
//-->
</script><?php echo $MaPage->GetHTMLFinPageHTML(); ?></body></html><?php $_PHP_VAR_TMP_10=ob_get_contents();ob_end_clean();echo _cp1252_to_utf8($_PHP_VAR_TMP_10); ?>